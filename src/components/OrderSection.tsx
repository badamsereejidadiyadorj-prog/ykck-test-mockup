...
const OrderSection = () => {
  ...
  return (
    <section id="order" className="py-24 lg:py-32 bg-primary text-primary-foreground">
        ...
        <form onSubmit={handleSubmit}>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="w-8 h-8 border border-primary-foreground/20 text-sm hover:bg-primary-foreground/10 active:scale-95 transition-all duration-150 flex items-center justify-center"
                  >
                    −
                  </button>
                  <span className="w-6 text-center font-display text-sm tabular-nums">
          ...
          <div data-reveal className="reveal-up grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8" style={{ transitionDelay: "300ms" }}>
            <input
              ...
              className="bg-transparent border border-primary-foreground/20 px-4 py-3 text-sm placeholder:opacity-40 focus:outline-none focus:border-primary-foreground/50 transition-colors"
            />
            <input
              type="email"
          ...
          <div data-reveal className="reveal-up text-center" style={{ transitionDelay: "400ms" }}>
            <button
              type="submit"
              className="bg-primary-foreground text-primary px-12 py-4 font-display font-semibold text-sm tracking-wide hover:opacity-90 active:scale-[0.97] transition-all duration-200 disabled:opacity-30"
              disabled={!hasItems}
            >
              Place Order — ${total}
            </button>
